...
Процедура Тест_ДолженПроверитьУровниВывода() Экспорт
	...
	юТест.ПроверитьРавенство(0, Лог.Уровни().Отключить);
	юТест.ПроверитьРавенство(1, Лог.Уровни().Отладка);
	юТест.ПроверитьРавенство(2, Лог.Уровни().Информация);
	юТест.ПроверитьРавенство(3, Лог.Уровни().Предупреждение);
	юТест.ПроверитьРавенство(4, Лог.Уровни().Ошибка);
	юТест.ПроверитьРавенство(5, Лог.Уровни().КритичнаяОшибка);
