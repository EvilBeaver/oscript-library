...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	СписокТестов.Добавить("ТестРекурсии");
...
Процедура ТестРекурсии() Экспорт
...
Процедура Рекурсия()
	Лог.Отладка("Рекурсия - счетчик = "+СчетчикРекурсии );
	//СчетчикРекурсии = СчетчикРекурсии - 1;
	Если СчетчикРекурсии > 0 Тогда
		Рекурсия1();
	КонецЕсли;
КонецПроцедуры

Процедура Рекурсия1()
	Лог.Отладка("Рекурсия1 - счетчик = "+СчетчикРекурсии );
	СчетчикРекурсии = СчетчикРекурсии - 1;
	Если СчетчикРекурсии > 0 Тогда
		Рекурсия();
	КонецЕсли;
