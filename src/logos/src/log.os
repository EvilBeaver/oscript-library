...
Процедура Вывести(Знач Сообщение, Знач УровеньСообщения,
	...
	// 		Параметр2, Параметр3, Параметр4, Параметр5, Параметр6, Параметр7, Параметр8, Параметр9);
	// КонецЕсли;
	Сообщение = СтрЗаменить(Сообщение, "%1", Параметр1);
	Сообщение = СтрЗаменить(Сообщение, "%2", Параметр2);
	Сообщение = СтрЗаменить(Сообщение, "%3", Параметр3);
	Сообщение = СтрЗаменить(Сообщение, "%4", Параметр4);
	Сообщение = СтрЗаменить(Сообщение, "%5", Параметр5);
	Сообщение = СтрЗаменить(Сообщение, "%6", Параметр6);
	Сообщение = СтрЗаменить(Сообщение, "%7", Параметр7);
	Сообщение = СтрЗаменить(Сообщение, "%8", Параметр8);
	Сообщение = СтрЗаменить(Сообщение, "%9", Параметр9);	
