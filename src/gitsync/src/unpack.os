...
Процедура ВыполнитьКоммитГит(Знач КаталогРабочейКопии, Знач Комментарий, Знач Автор, Знач Дата=Неопределено) Экспорт 
	...
	КомандаКоммита = "git commit -a --file="""+ИмяФайлаКомментария+""" --author="""+Автор+""" ";
	...
	рез = ВыполнитьКомандныйФайл(КомандныйФайл, КаталогРабочейКопии);
...
Функция ВыполнитьGitPush(Знач ЛокальныйРепозиторий, Знач УдаленныйРепозиторий, Знач ИмяВетки) Экспорт
	...
	Результат = ВыполнитьКомандныйФайл(КомандныйФайл, ЛокальныйРепозиторий);
	ЗавершитьПроцесс_TGitCache_exe();
...
Функция ВыполнитьКомандныйФайл(Знач ДескрипторКомандногоФайла, Знач ТекущийКаталог = "")
	Возврат ДескрипторКомандногоФайла.Выполнить(ТекущийКаталог);
КонецФункции
...
Функция КлонироватьРепозитарий(Знач КаталогЛокальнойКопии, Знач URLРепозитария) Экспорт
	...
	РезультатКлонирования = ВыполнитьКомандныйФайл(Батник, КаталогЛокальнойКопии);
...
Функция ИнициализироватьРепозитарий(Знач КаталогЛокальнойКопии) Экспорт
	...
	Результат = ВыполнитьКомандныйФайл(Батник, КаталогЛокальнойКопии);
