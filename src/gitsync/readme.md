...
* [-gitpublish on|off] - получать, публиковать ли данные с внешнего git сервера. При указаинии off <адрес (url) репозитария> можно указывать любую строку. Данные параметр пригодиться при использовании внешних средств для получения и отправки данных (в jenkins это git publisher)
