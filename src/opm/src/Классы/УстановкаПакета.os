...
Процедура РазрешитьЗависимостиПакета(Знач Метаданные)
	
	Лог.Отладка("Разрешение зависимостей не реализовано");
...
Процедура ПрочитатьМетаданныеПакета(Знач ФайлМетаданных)
