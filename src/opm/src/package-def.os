...
Функция ВключитьФайл(Знач ИсходныйПуть, Знач ПутьВнутриПакета = Неопределено) Экспорт
	
	ВключаемыйФайл = мВключаемыеФайлы.Добавить();
	ВключаемыйФайл.ИсходныйПуть = ИсходныйПуть;
	ВключаемыйФайл.ПутьВнутриПакета = ПутьВнутриПакета;
	Возврат ЭтотОбъект;
	
КонецФункции

Функция ВключаемыеФайлы() Экспорт
	Возврат мВключаемыеФайлы.Скопировать();
КонецФункции
...
Процедура Инициализация()
	...
	мВключаемыеФайлы = Новый ТаблицаЗначений;
	мВключаемыеФайлы.Колонки.Добавить("ИсходныйПуть");
	мВключаемыеФайлы.Колонки.Добавить("ПутьВнутриПакета");
